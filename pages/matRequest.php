...
<div class="mt-32 bg-gray-300 shadow-2xl rounded-2xl p-6 w-full max-w-sm transform transition duration-500 hover:scale-105 hover:shadow-3xl mx-auto" style="height: 700px">
    <p class="text-center text-gray-500 text-sm mb-6">Informatique Department Materiel Request Portal</p>
    <h3 class="text-center text-2xl font-semibold text-gray-800 mb-8">Request Your Materiel</h3>

    <!-- Materiel Request Form -->
    <form id="matRequestForm" method="POST" action="../class/materielHandler.php" onsubmit="return showPopup(event)">
        <!-- Materiel Type -->
        <div class="mb-6 relative">
            <label for="materielType" class="block text-gray-600 font-medium mb-2">Select Materiel Type</label>
            <div class="relative">
                <select id="materielType" name="type-materiel"
                    ...
                    <option value="">-- Select Needed Materiel --</option>
                    <option value="datashow 1">Datashow 1 - Acer Noire</option>
                    <option value="datashow 2">Datashow 2 - Dell Blanc</option>
                    <option value="datashow 3">Datashow 3 - Sony Noire</option>
                    <option value="printer 1">Printer 1 - Nicon Gris</option>
                    <option value="printer 2">Printer 2 - Sony Blanche</option>
...
<div id="successPopup" 
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-80 text-center">
        <h3 class="text-lg font-bold text-blue-400">Request Submitted!</h3>
        <p class="text-gray-600 mt-2">Your request has been successfully submitted.</p>
...
function showPopup(event) {
    ...
    document.getElementById("closePopupButton").addEventListener("click", function() {
        ...
        document.getElementById("matRequestForm").submit();
    });
}

</script>
    <script src="./matReq.js"></script>
</body>
